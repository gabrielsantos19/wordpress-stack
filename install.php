...
$admin_password_check = $admin_password;
$admin_email          = getenv( 'ADMIN_EMAIL' ) ? trim( wp_unslash( getenv( 'ADMIN_EMAIL' ) ) ) : '';
$public               = getenv( 'BLOG_PUBLIC' ) ? (int) getenv( 'BLOG_PUBLIC' ) : 1;

$step = 2;
// NOT ORIGINAL WORDPRESS END
